...
with st.form("get_recommendation"):
   ...
   if submitted:
       #fetch recommendation only if the confidence percentage is greater than or equal to 90
       confirm=model.generate_content("is the following sentence talking about movies "+search+".If yes, then is the confidence percentage greater than or equal to 90. Only say yes or no")
